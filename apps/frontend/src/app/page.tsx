        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="rounded-2xl bg-red-500 px-4 py-2.5 text-sm font-semibold transition hover:bg-red-600"
            >
              Logout
            </button>
          </div>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <h3 className="mt-1 text-xl font-black text-red-400">
                    ₹{totalSpent}
                  </h3>
                </div>
          ...
          <div className="space-y-5 lg:col-span-8">
            ...
            >
              ...
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="rounded-2xl bg-violet-500/10 px-3 py-1 text-xs text-violet-400">
                  LIVE
                </div>
              </div>
                  ...
                  (expense) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-lg font-black text-pink-400">
                          ₹
                          {
                            expense.amount
                          }
